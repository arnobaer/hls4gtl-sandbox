...
{
#pragma HLS ARRAY_PARTITION variable=output.data32 complete dim=0
#pragma HLS ARRAY_PARTITION variable=output.data128 complete dim=0

    static xorshift32 gen32[output_type::size] = {
    ...
    {
#pragma HLS unroll
        output.data32[i] = gen32[i].next();
    }

    static xorshift128 gen128[output_type::size] = {
    ...
    {
#pragma HLS unroll
        output.data128[i] = gen128[i].next();
    }
}
